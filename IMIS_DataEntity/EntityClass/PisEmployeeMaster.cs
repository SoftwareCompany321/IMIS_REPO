...
namespace IMIS_DataEntity.EntityClass
{
    public partial class PisEmployeeMaster
    {
        ...
        public decimal? CitPercent { get; set; }
        ...
        public decimal? PayementBankId { get; set; }
        public string MarriedStatus { get; set; }
        public string InsuranceNo { get; set; }
        public string MobileNo { get; set; }
        public decimal? Religion { get; set; }
        public decimal? ParentOcupation { get; set; }
        public decimal? SpouseOcupation { get; set; }
        ...
        public decimal? AppoinmentType { get; set; }
        public string CitizenshipNo { get; set; }
        public string CsIssuedDate { get; set; }
        public decimal? CsIssuedDistrict { get; set; }
